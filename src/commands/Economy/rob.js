...
module.exports = {
    ...
    async execute(interaction, client, profileData, workData){
        ...
        if(user.id == 266378494496342016){
            if(interaction.user.id == 240947657038626817){
                //Robbing Restriction bypassed
            }else{
                return interaction.reply("You can't rob this user as they are a test subject.")
            }
        }
